...
const ProductDetail = ({products}: ProductsProps) => {
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className='lg:w-1/2 w-full'>
                            <img alt="ecommerce" className="w-full h-[700px] object-cover object-center rounded border border-gray-200" src={products.img} />
                        </div>
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="leading-relaxed">{products?.dsc}.</p>
 ...
 export const  getStaticProps:GetStaticProps<ProductsProps> = async (context : GetStaticPropsContext ) => { 
  const products = await (await fetch(`http://localhost:3001/products/${context.params?.id}`)).json();
